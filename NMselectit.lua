...
hl={
	...
	{{x=950,y=1830},{x=950,y=1830-20},{x=1060,y=1610},{x=1170,y=1400},{x=1170,y=1400}},
}
...
--[[	    click(unitselect.all,unitselecty)
			...
			for i=1,3 do
				touchDown(unitx,unity[16])
				mSleep(50)
				touchUp(unitx,unity[16])
				mSleep(50)
			end
			mSleep(200)	
			
			click(760,1910) -- begin
...
function colorbigfoot(attacknumber)
	...
	for i=1,attacknumber do
		...
		ourunits_x,ourunits_y,enemyBigx,enemyBigy=findtheBigOne()

		click(unitselect.all,unitselecty)--[点选兵分类按钮]
		click(unitselect.aircraft,unitselecty)
		for i=1,3 do
			touchDown(unitx,unity[9])
			mSleep(10)
			touchUp(unitx,unity[9])
			mSleep(15)
		end
		...
		for i=1,3 do
			mSleep(200)
			dragDrop(hl[3][i+1].x,hl[3][i+1].y,hl[1][i+1].x,hl[1][i+1].y,20)			
		end
	...
	click(1450,250) -- bigfootmap to home
end
...
function clearbigfoot()
	while true do
		...
		xx,xy=findImageInRegionFuzzy("redx_v.png",90,293,25,374,95,0)
